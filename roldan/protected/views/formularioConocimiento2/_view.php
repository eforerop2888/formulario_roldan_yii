...
/* @var $data FormularioConocimiento2 */
?>
...
<div class="view">
	...
	<b><?php echo CHtml::encode($data->getAttributeLabel('cuenta_refban_1')); ?>:</b>
	<?php echo CHtml::encode($data->cuenta_refban_1); ?>
	<br />
	...
	<b><?php echo CHtml::encode($data->getAttributeLabel('cuenta_refban_2')); ?>:</b>
	<?php echo CHtml::encode($data->cuenta_refban_2); ?>
	<br />
	...
	<b><?php echo CHtml::encode($data->getAttributeLabel('grandes_contribuyentes')); ?>:</b>
	<?php echo CHtml::encode($data->grandes_contribuyentes); ?>
	<br />

	<b><?php echo CHtml::encode($data->getAttributeLabel('retenedores')); ?>:</b>
	<?php echo CHtml::encode($data->retenedores); ?>
	<br />
	...
	<b><?php echo CHtml::encode($data->getAttributeLabel('banco_forma_pago')); ?>:</b>
	<?php echo CHtml::encode($data->banco_forma_pago); ?>
	<br />
