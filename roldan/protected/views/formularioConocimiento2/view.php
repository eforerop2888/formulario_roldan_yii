...
$this->menu=array(
	...
	array('label'=>'Update FormularioConocimiento2', 'url'=>array('update', 'id'=>$model->identificacion)),
	array('label'=>'Delete FormularioConocimiento2', 'url'=>'#', 'linkOptions'=>array('submit'=>array('delete','id'=>$model->identificacion),'confirm'=>'Are you sure you want to delete this item?')),
	array('label'=>'Manage FormularioConocimiento2', 'url'=>array('admin')),
);
?>

<h1>View FormularioConocimiento2 #<?php echo $model->identificacion; ?></h1>
