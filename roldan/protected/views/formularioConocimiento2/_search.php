...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="row">
		<?php echo $form->label($model,'cuenta_refban_1'); ?>
	...
	<div class="row">
		<?php echo $form->label($model,'cuenta_refban_2'); ?>
	...
	<div class="row">
		<?php echo $form->label($model,'grandes_contribuyentes'); ?>
		<?php echo $form->textField($model,'grandes_contribuyentes'); ?>
	</div>

	<div class="row">
		<?php echo $form->label($model,'retenedores'); ?>
	...
	<div class="row">
		<?php echo $form->label($model,'banco_forma_pago'); ?>
