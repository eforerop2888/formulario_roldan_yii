...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="row">
		...
		<?php echo $form->radioButtonList($model,'grandes_contribuyentes',array(1=>'Si',2=>'No'), array('labelOptions'=>array('style'=>'display:inline'),'separator'=>'  ',));?>
		<?php echo $form->error($model,'grandes_contribuyentes'); ?>
	</div>

	<div class="row">
		<?php echo $form->labelEx($model,'retenedores'); ?>
		<?php echo $form->radioButtonList($model,'retenedores',array(1=>'IVA',2=>'ICA',3=>'Retención'), array('labelOptions'=>array('style'=>'display:inline'),'separator'=>'  ',));?>
		<?php echo $form->error($model,'retenedores'); ?>
	</div>

	<div class="row">
		<?php echo $form->labelEx($model,'forma_pago'); ?>
		<?php echo $form->radioButtonList($model,'forma_pago',array(1=>'Consignación',2=>'Cheque',3=>'Transferencia'), array('labelOptions'=>array('style'=>'display:inline'),'separator'=>'  ',));?>
